...
/* These are the Android classes used in the LearningMenu.java class. */
...
/* Inheritance is used as it allows the LearningMenu.java class to inherit the public and protected methods and variables from the superclass and to override methods.
...
/* I have created private variables which define all of the widgets used in the activity_learning_menu.xml file. */
...
/* This specifies which layout is to be used, in this case the activity_learning_menu.xml file. */
...
describes what activity will be carried out next. */
       eating.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LearningMenu.this,LearnEating.class);
        ...
        exercise.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LearningMenu.this,LearnExercise.class);
                startActivity(intent);
            }
        });
    }
...
/* All of the variables are assigned to their corresponding ID attribute (widget) from the activity_learning_menu.xml file. */
